...
const CustomerDashBoard= () => {
  ...
  const handlePassbook = (obj) =>{
    console.log(obj)
    navigation(`/passbook/${obj.accountnumber}/${username}`)
  }

  const headers = ["A/C No.","Bank Id", "Balance"]
  const functions = [handlePassbook]
  const functionHeaders = ["View Passbook"]
  return (
